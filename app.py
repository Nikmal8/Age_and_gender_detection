...
def main():
    ...
    if choice == "Home":
        ...
        st.write("""
                 ...
                 2. Real time Age and Gender recognization.

                 """)
    elif choice == "Webcam Face Detection":
        st.header("Webcam Live Feed")
        st.write("Click on start to use webcam and detect your Age and Gender")
        ...
        html_temp_about1= """<div style=padding:10px">
                                    <h4 style=text-align:center;">
                                    Real time Age and Gender detection application using OpenCV, Custom Trained CNN model and Streamlit.</h4>
                                    </div>
                                    </br>"""
